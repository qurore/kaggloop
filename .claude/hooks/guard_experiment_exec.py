...
RULES = [
    ...
    (r"\.kaggle/(kaggle\.json|access_token)|\$KAGGLE_KEY|KAGGLE_KEY=|\$KAGGLE_API_TOKEN|KAGGLE_API_TOKEN=|\bKGAT_[A-Za-z0-9]",
     "reading/printing Kaggle API credentials — never echo or upload the token / kaggle.json"),
